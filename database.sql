...
LOCK TABLES `group_media` WRITE;
/*!40000 ALTER TABLE `group_media` DISABLE KEYS */;
/*!40000 ALTER TABLE `group_media` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `permissies`
--
...
--
-- Dumping data for table `permissies`
--

LOCK TABLES `permissies` WRITE;
/*!40000 ALTER TABLE `permissies` DISABLE KEYS */;
/*!40000 ALTER TABLE `permissies` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `reactie` WRITE;
/*!40000 ALTER TABLE `reactie` DISABLE KEYS */;
/*!40000 ALTER TABLE `reactie` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-05-08 10:20:47
